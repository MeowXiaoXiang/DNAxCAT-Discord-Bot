...
class Common(commands.Cog):
    ...
    @app_commands.command(name="website", description="九藏喵窩官方網站")
    ...
    @app_commands.command(name="forum", description="九藏喵窩論壇")
    ...
    @app_commands.command(name="youtube", description="九藏喵窩動畫 YouTube 頻道")
    ...
    @app_commands.command(name="wiki", description="九藏喵窩 Wiki")
